...
function InitWeb()
{
    ...
    var functionGroup = {
        ...
        __init__ : function(){
            ...
            dataGroup.isIe = isIe;
            dataGroup.isIE6 = isIE6;
            dataGroup.style.winSize = functionGroup.getWindowSize();
        },
        //获取屏幕大小、尺寸
        ...
        logOff : function () {
            if(app_self.constDom.menu.user.online)
            {
                functionGroup.http.get(
                    static_data.getUrlPath("LogOff.php",static_data.m_URL_DOMAIN_API_DIR),
                    {},
                    {},
                    function(data)
                    {
        ...
        passJct : function() {
            functionGroup.http.post(
                static_data.getUrlPath("User.php",static_data.m_URL_DOMAIN_API_DIR),
                {},
                {},
                function(data)
                {
        ...
        alertBox : function (msg, mode) {
            msg = msg || '';
            mode = mode || 0;
            var winSize = functionGroup.getWindowSize();
            //弹出框
