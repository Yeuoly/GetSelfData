...
( function( global, factory ) {
    ...
    if ( typeof module === "object" && typeof module.exports === "object" ) {
        ...
        // See ticket #14549 for more others.
    ...
    function on( elem, types, selector, data, fn, one ) {
        ...
        if ( one === 1 ) {
            ...
            fn = function( event ) {
                ...
                // Can use an empty set, since event contains the others
                jQuery().off( event );
        ...
        jQuery.cssHooks[ dimension ] = {
            get: function( elem, computed, extra ) {
                if ( computed ) {
                    ...
                    // Certain elements can have dimension others if we invisibly show them
